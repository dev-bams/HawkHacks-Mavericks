      ...
      <div className="container max-w-4xl">
        ...
        <div className="course-description p-8 ">
          ...
          <p>
            ...
            ahead of evolving cyber threats. This advanced-level course delves
            into sophisticated cybersecurity techniques, tools, and strategies
            employed by industry experts to safeguard critical systems and data
